...
<!-- This is done to show name of the subject which you have selected at the top  -->
    <?php
    ...
    ?>
    <div class="container mt-4 mb-6" id="ques">
        <h1 class="text-center my-3"><?php echo $subject_name ?></h1>
        <div class="row">
...
<!-- BROWSING CATEGORIES | CARDS -->
        ...
        // now we are telling to give me all categories from the database which we have connected
                $sql = "SELECT * FROM `categories` where subject_id = '$subject_id'";
                $result = mysqli_query($conn, $sql);
        // now we will fetch all categories and will display it on home screen using loop
                while ($row = mysqli_fetch_array($result)) {
                    $id = $row['category_id'];   
                    $name = $row['category_name'];   // storing category name in a variable so that we can display it in title
                ...
                <div class="col-md-4 my-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title "><a class="text-decoration-none" href="threadlist.php?catid='.$id.'">' . $name . '</a></h5>
                ...
                echo '<div class="container ">
                        <div class="col-md-12 my-4 ">
                            <div class="h-100 p-5 text-light bg-secondary rounded-3">
                                <h1 class="fs-2rem">No Result found</h1>
                            </div>
                        </div>
                    </div>';
            }
